...
class AWAIKEN_Theme_Updater_Admin {
	...
	public function license_activation_failed_page() {
		?>
		<div class="wrap">
			<h2><?php _e( 'License activation page failed to load', 'artistics' ); ?></h2>
			<style>
		...
		<p><?php _e( 'Please contact us at our email support@awaiken.com and provide the following details. Our team will assist you in resolving the issue.', 'artistics' ); ?></p>
		<ol>
			<li><?php _e( 'Item purchase code', 'artistics' ); ?></li>
			<li><?php _e( 'Server IP address', 'artistics' ); ?></li>
			<li><?php _e( 'Site URL', 'artistics' ); ?></li>
		</ol>
		</div>
		<?php 
	}
 ...
 */
function artistics_theme_admin_notices() {
...
add_action( 'admin_notices', 'artistics_theme_admin_notices' );
