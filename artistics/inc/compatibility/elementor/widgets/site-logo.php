 ...
 * @since 1.0.0
 */
class artistic_widget_site_Logo extends Widget_Base {
	...
	public function get_title() {
		return __( 'Artistic - Site Logo', 'artistics' );
	}
	...
	protected function register_content_site_logo_controls() {
		...
		$this->add_control(
			'site_logo_fallback',
			array(
				'label'       => __( 'Custom Image', 'artistics' ),
				'type'        => Controls_Manager::SWITCHER,
				'yes'         => __( 'Yes', 'artistics' ),
				'no'          => __( 'No', 'artistics' ),
				'default'     => 'no',
		...
		$this->add_responsive_control(
			'align',
			array(
				'label'              => __( 'Alignment', 'artistics' ),
				'type'               => Controls_Manager::CHOOSE,
				'options'            => array(
					'left'   => array(
						'title' => __( 'Left', 'artistics' ),
						'icon'  => 'eicon-text-align-left',
					),
					'center' => array(
						'title' => __( 'Center', 'artistics' ),
						'icon'  => 'eicon-text-align-center',
					),
					'right'  => array(
						'title' => __( 'Right', 'artistics' ),
		...
		$this->add_control(
			'caption',
			array(
				'label'       => __( 'Custom Caption', 'artistics' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '',
				'placeholder' => __( 'Enter caption', 'artistics' ),
				'condition'   => array(
					'caption_source' => 'yes',
				),
				'dynamic'     => array(
		...
		$this->add_control(
			'link_to',
			array(
				'label'   => __( 'Link', 'artistics' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => array(
					'default' => __( 'Default', 'artistics' ),
					'none'    => __( 'None', 'artistics' ),
					'file'    => __( 'Media File', 'artistics' ),
					'custom'  => __( 'Custom URL', 'artistics' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'placeholder' => __( 'https://your-link.com', 'artistics' ),
				'condition'   => array(
					'link_to' => 'custom',
				),
				'show_label'  => false,
	...
	protected function register_site_logo_styling_controls() {
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Background Color', 'artistics' ),
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'Border Style', 'artistics' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => 'none',
				'label_block' => false,
				'options'     => array(
					'none'   => __( 'None', 'artistics' ),
					'solid'  => __( 'Solid', 'artistics' ),
					'double' => __( 'Double', 'artistics' ),
					'dotted' => __( 'Dotted', 'artistics' ),
					'dashed' => __( 'Dashed', 'artistics' ),
				),
				'selectors'   => array(
		...
		$this->add_control(
			...
			array(
				'label'      => __( 'Border Width', 'artistics' ),
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Border Color', 'artistics' ),
				'type'      => Controls_Manager::COLOR,
				'global'    => array(
		...
		$this->add_responsive_control(
			'image_border_radius',
			array(
				'label'              => __( 'Border Radius', 'artistics' ),
				'type'               => Controls_Manager::DIMENSIONS,
				'size_units'         => array( 'px', '%' ),
				'selectors'          => array(
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Transition Duration', 'artistics' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'max'  => 3,
		...
		$this->add_control(
			'hover_animation',
			array(
				'label' => __( 'Hover Animation', 'artistics' ),
